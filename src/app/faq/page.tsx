      ...
      <Accordion type="multiple">
        ...
        >
          ...
          <p>
            ...
            student athlete can bypass the waitlist (and allow others to join!)
            if one parent/guardian completes the coach training and{" "}
        ...
        >
          <AccordionContent>
            ...
            <ul className="list-inside list-disc">
              ...
              <li>
                Series racing fees: VAHS for the spring season, NICA for the
                fall season. These fees are paid directly to the league and are
                not collected by Fredericksburg Composite MTB Team.
              </li>
            </ul>
          </AccordionContent>
        </CustomAccordionItem>
        <CustomAccordionItem
          id="3"
          trigger="When/where does the team practice?"
        >
          <AccordionContent>
            The team typically rotates practice locations between Mott&apos;s
            Run Reservoir, Locust Shade Park, and the Quarry. Specific times and
